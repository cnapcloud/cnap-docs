...
- [3. 디렉터리 구조](#3-디렉터리-구조)
- [4. 사전 설정](#4-사전-설정)
  - [4.1 Keycloak Client 생성](#41-keycloak-client-생성)
  - [4.2 Keycloak Groups 설정](#42-keycloak-groups-설정)
- [5. 배포](#5-배포)
  - [5.1 Namespace 생성](#51-namespace-생성)
  - [5.2 Helm Chart 준비](#52-helm-chart-준비)
  - [5.3 `values.yaml` 커스터마이징](#53-valuesyaml-커스터마이징)
  - [5.4 Kustomization 구성](#54-kustomization-구성)
  - [5.5 배포 프로세스](#55-배포-프로세스)
- [6. 설치 후 검증 (기본 설치)](#6-설치-후-검증-기본-설치)
- [7. Keycloak OIDC 연동 (SSO)](#7-keycloak-oidc-연동-sso)
  - [7.1 필수 플러그인 설치](#71-필수-플러그인-설치)
  - [7.2 Keycloak에서 OIDC 클라이언트 생성](#72-keycloak에서-oidc-클라이언트-생성)
  - [7.3 Jenkins에서 OIDC 인증 설정](#73-jenkins에서-oidc-인증-설정)
  - [7.4 권한 관리 설정 (Matrix Authorization Strategy)](#74-권한-관리-설정-matrix-authorization-strategy)
  - [7.5 OIDC 로그인 검증](#75-oidc-로그인-검증)
- [8. GitHub 연동 설정](#8-github-연동-설정)
  - [8.1 필수 플러그인 설치](#81-필수-플러그인-설치)
  - [8.2 GitHub Personal Access Token 발급](#82-github-personal-access-token-발급)
  - [8.3 Jenkins Credentials 등록](#83-jenkins-credentials-등록)
  - [8.4 GitHub Server 등록](#84-github-server-등록)
  - [8.5 Multibranch Pipeline 생성](#85-multibranch-pipeline-생성)
- [9. GitLab 연동 설정](#9-gitlab-연동-설정)
  - [9.1 필수 플러그인 설치](#91-필수-플러그인-설치)
  - [9.2 GitLab Personal Access Token 발급](#92-gitlab-personal-access-token-발급)
  - [9.3 Jenkins Credentials 등록](#93-jenkins-credentials-등록)
  - [9.4 GitLab 서버 등록](#94-gitlab-서버-등록)
  - [9.5 Multibranch Pipeline 생성 (GitLab)](#95-multibranch-pipeline-생성-gitlab)
  - [9.6 GitLab Webhook 설정](#96-gitlab-webhook-설정)
  - [9.7 GitLab Outbound Requests 허용](#97-gitlab-outbound-requests-허용)
  - [9.8 GitLab 연동 검증](#98-gitlab-연동-검증)
- [10. Dashboard 뷰 구성](#10-dashboard-뷰-구성)
  - [10.1 새로운 뷰 생성](#101-새로운-뷰-생성)
  - [10.2 뷰 설정](#102-뷰-설정)
- [11. 파이프라인 작성 예시 (GitHub 기준)](#11-파이프라인-작성-예시-github-기준)
  - [11.1 Makefile 작성](#111-makefile-작성)
  - [11.2 Jenkinsfile 작성 (GitHub 연동)](#112-jenkinsfile-작성-github-연동)
  - [11.3 필수 Credentials 설정](#113-필수-credentials-설정)
  - [11.4 파이프라인 테스트](#114-파이프라인-테스트)
  - [11.5 파이프라인 커스터마이징 팁](#115-파이프라인-커스터마이징-팁)
- [12. 추가 플러그인 설치 (권장)](#12-추가-플러그인-설치-권장)
  - [12.1 Prometheus 플러그인 설정](#121-prometheus-플러그인-설정)
  - [12.2 기타 유용한 플러그인 목록](#122-기타-유용한-플러그인-목록)
  - [12.3 플러그인 설치 방법](#123-플러그인-설치-방법)
- [13. Jenkins 설정 백업 및 복원](#13-jenkins-설정-백업-및-복원)
  - [13.1 백업/복원 개요](#131-백업복원-개요)
  - [13.2 백업](#132-백업)
  - [13.3 복원](#133-복원)
  - [13.4 권장사항](#134-권장사항)
- [14. 문제 해결 (Troubleshooting)](#14-문제-해결-troubleshooting)
  - [14.1 Pod Pending 상태](#141-pod-pending-상태)
  - [14.2 Ingress 접속 불가](#142-ingress-접속-불가)
  - [14.3 GitHub 연결 실패](#143-github-연결-실패)
  - [14.4 GitHub Webhook이 작동하지 않음](#144-github-webhook이-작동하지-않음)
  - [14.5 빌드 에이전트 Pod 생성 실패](#145-빌드-에이전트-pod-생성-실패)
  - [14.6 GitLab 연결 실패](#146-gitlab-연결-실패)
  - [14.7 GitLab Webhook이 작동하지 않음](#147-gitlab-webhook이-작동하지-않음)
  - [14.8 OIDC 로그인 실패](#148-oidc-로그인-실패)
- [15. 참고 정보](#15-참고-정보)
  - [15.1 Jenkins API Token 사용](#151-jenkins-api-token-사용)
  - [15.2 참고 자료- Jenkins 공식 문서](#152-참고-자료--jenkins-공식-문서)
