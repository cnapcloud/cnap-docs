...
**목차**
- [1. 개요](#1-개요)
- [2. 설치 환경 구성](#2-설치-환경-구성)
  - [2.1 Kubernetes 구축](#21-kubernetes-구축)
  - [2.2 GitOps 도구 설치](#22-gitops-도구-설치)
  - [2.3 GPG 키 생성 및 SOPS 설정](#23-gpg-키-생성-및-sops-설정)
- [3. 설치 순서](#3-설치-순서)
  - [3.1 네트워크 및 인증서 관리](#31-네트워크-및-인증서-관리)
  - [3.2 데이터베이스 플랫폼](#32-데이터베이스-플랫폼)
  - [3.3 인증 및 트래픽 관리 플랫폼](#33-인증-및-트래픽-관리-플랫폼)
  - [3.4 CI/CD 플랫폼](#34-cicd-플랫폼)
  - [3.5 관측성 플랫폼](#35-관측성-플랫폼)
  - [3.6 애플리케이션](#36-애플리케이션)
- [4. 모듈 배포](#4-모듈-배포)
  - [4.1 GitOps 모듈 폴더 구조](#41-gitops-모듈-폴더-구조)
  - [4.2 모듈 배포 설정](#42-모듈-배포-설정)
  - [4.3 기본 구성 변경](#43-기본-구성-변경)
  - [4.4 배포 전 확인 사항](#44-배포-전-확인-사항)
  - [4.5 배포 방법](#45-배포-방법)
- [5. 도메인 및 인증서 구성](#5-도메인-및-인증서-구성)
  - [5.1 도메인 등록](#51-도메인-등록)
  - [5.2 TLS 인증서 구성](#52-tls-인증서-구성)
- [6. Keycloak 통합 인증 구성](#6-keycloak-통합-인증-구성)
  - [6.1 Client Scopes 설정 (공통)](#61-client-scopes-설정-공통)
  - [6.2 각 클라이언트 생성](#62-각-클라이언트-생성)
- [7. 참고 자료](#7-참고-자료)
