...
**목차**
- [1. 클러스터 구성](#1-클러스터-구성)
  - [방법 A: Multipass 자동 구성 (로컬 테스트 환경)](#방법-a-multipass-자동-구성-로컬-테스트-환경)
    - [VM 사양 설정](#vm-사양-설정)
    - [VM 생성 및 관리](#vm-생성-및-관리)
    - [hosts.env IP 업데이트](#hostsenv-ip-업데이트)
  - [방법 B: 수동 구성 (실제 서버)](#방법-b-수동-구성-실제-서버)
- [2. k3sup 설치](#2-k3sup-설치)
- [3. SSH 키 준비](#3-ssh-키-준비)
- [4. hosts.env 설정](#4-hostsenv-설정)
- [5. 전체 자동 실행](#5-전체-자동-실행)
- [6. 단계별 실행](#6-단계별-실행)
  - [6.1 사전 준비 (전 노드)](#61-사전-준비-전-노드)
  - [6.2 첫 번째 Master 초기화](#62-첫-번째-master-초기화)
  - [6.3 추가 Master 조인](#63-추가-master-조인)
  - [6.4 etcd 스냅샷 보관 설정](#64-etcd-스냅샷-보관-설정)
  - [6.5 Worker 조인](#65-worker-조인)
  - [6.6 Post-setup](#66-post-setup)
  - [6.7 Addon 설치](#67-addon-설치)
- [7. 설치 확인](#7-설치-확인)
- [8. 클러스터 검증 (Nginx 테스트)](#8-클러스터-검증-nginx-테스트)
- [9. 파일 구조](#9-파일-구조)
...
### 방법 A: Multipass 자동 구성 (로컬 테스트 환경)
